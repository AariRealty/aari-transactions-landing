...
BEGIN
  ...
  WITH src AS (
    SELECT * FROM (VALUES
      ...
      ('Ariana Jach', '@arianajachh', 'IG search', 'In Conversation', NULL, '2026-05-07 12:00:00+00'::timestamptz),
      ...
      ('Samantha Haringa', '@samantha.haringa', 'IG search', 'In Conversation', NULL, '2026-05-07 12:00:00+00'::timestamptz),
