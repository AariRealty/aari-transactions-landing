...
(function aariBanner(){
  ...
  const CSS = `
    ...
    #aari-banner{background:var(--awb-cream);border-bottom:0.5px solid var(--awb-line);font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Inter,Arial,sans-serif;position:sticky;top:0;z-index:50}
