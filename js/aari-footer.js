...
(function () {
  ...
  var CSS = [
    ...
    '.aari-foot-bottom{padding:22px 32px 24px;max-width:1100px;margin:0 auto;font-size:11px;color:#888;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:14px;letter-spacing:0.3px;font-family:inherit;border-top:1px solid #2a2a2a;margin-top:36px}',
    '.aari-foot-bottom .aari-foot-contact{color:#fff;font-family:"Cormorant Garamond",Georgia,serif;font-size:13.5px;letter-spacing:-0.1px}',
    '.aari-foot-bottom .aari-foot-contact a{color:#fff}',
    '.aari-foot-bottom a{color:#888}',
  ...
  var HTML = [
    ...
    '    <span class="aari-foot-contact"><a href="tel:2396881770">239.688.1770</a> &middot; <a href="mailto:hello@aaritransactions.com">hello@aaritransactions.com</a> &middot; Fort Myers, FL</span>',
    '    <span>&copy; ' + year + ' Aari Transactions LLC &middot; Operated under Aari Realty &middot; BK3530153 &middot; <a href="/privacy.html">Privacy</a> &middot; <a href="/terms.html">Terms</a> &middot; <a href="https://www.instagram.com/marlenyi.paredes/" target="_blank" rel="noopener">Instagram</a></span>',
    '  </div>',
    '</footer>'
  ].join('\n');
